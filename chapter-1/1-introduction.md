...
Вся книга разделена на три большие части. Первая — это введение и описание самой книги. Главу из этой части наряду со [следующей](1.1-architecture-performance-and-games.md) вы сейчас и читаете.

Вторая часть — [Обзор шаблонов проектирования](2-design-patterns-revisited.md) рассматривает несколько шаблонов из книги банды четырех. Относительно каждого я высказываю собственное мнение и описываю его применимость в игровом программировании.

И, наконец, последняя часть — это сама соль данной книги. В ней описаны тринадцать новых шаблонов, которые я видел в играх. Она делится еще на четыре части: [Последовательные шаблоны](3-sequencing-patterns.md) (sequencing), [Поведенческие шаблоны](4-behavioral-patterns.md) (behavioral), [Шаблоны уменьшения связности](5-decoupling-patterns.md) (decoupling) и [Оптимизационные шаблоны](6-optimization-patterns.md) (optimization).
