...
Вся книга разделена на три большие части. Первая — это введение и описание самой книги. Главу из этой части наряду со [следующей](./chapter-1/1.1-architecture-performance-and-games) вы сейчас и читаете.

Вторая часть — [Обзор шаблонов проектирования](./chapter-2/2-design-patterns-revisited) рассматривает несколько шаблонов из книги банды четырех. Относительно каждого я высказываю собственное мнение и описываю его применимость в игровом программировании.

И, наконец, последняя часть — это сама соль данной книги. В ней описаны тринадцать новых шаблонов, которые я видел в играх. Она делится еще на четыре части: [Последовательные шаблоны](./chapter-3/3-sequencing-patterns) (sequencing), [Поведенческие шаблоны](./chapter-4/4-behavioral-patterns) (behavioral), [Шаблоны уменьшения связности](./chapter-5/5-decoupling-patterns) (decoupling) и [Оптимизационные шаблоны](./chapter-6/6-optimization-patterns) (optimization).
